...
# Inputs:
#   time: days
#   semimajor axis: stellar radii (HUSK AT ÆNDRE RADIUS!!)
#   mass: solar mass
#   obliquity: degrees
#   inclination: degrees
...
# Parametre for vores data
R = 2.1 * 695510000 # m
t_p = 0
a = 4.403#4.756#9.25 #rnd.randint(20, 100)/10
...
obl = -70#rnd.randint(-180, 180)
incl = 87#rnd.randint(80, 100)
omega = 90
RV_amp = 109#rnd.randint(0,100)/10

# Tilfældige parametre
#t_p = 0
#a = 2.4#rnd.randint(20, 100)/10
#e = 0.3#rnd.randint(0,30)/100
#m1 = 1.1#rnd.randint(10,100)/10
#m2 = 0.123#rnd.randint(1,1000)/1000
#rad_rat = 0.1#rnd.randint(1,100)/200
#obl = -174#rnd.randint(-180, 180)
#incl = 85#rnd.randint(80, 100)
#omega = 90
#RV_amp = 8.5#rnd.randint(0,100)/10
...
centroids, centroids_avg, gaussians, X, Y, RV_x, L_sum_p, X_p, Y_p = rm_function(t, t_p, a, e, m1, m2, rad_rat, obl, incl, omega, RV_amp, R, return_option=3)
